...
public class MapMain {
    public static void main(String[] args) {
        ...
        for (@SuppressWarnings("rawtypes") Map.Entry entry : jingzhongyue.entrySet()) {
    ...
    System.out.println();
        ...
        for (@SuppressWarnings("rawtypes") Map.Entry entry : jedis.hgetAll("daxia:jingzhongyue").entrySet()) {
            System.out.println(entry.getKey() + ":" + entry.getValue());
        }
